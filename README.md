...
.logo_h__txt, .logo_link { font: bold 40px/48px Raleway;  color:#23ba85; }
...
<body class="home page page-id-203 page-template page-template-page-home page-template-page-home-php theme52547">
	<div id="motopress-main" class="main-holder stuck">
		<!--Begin #motopress-main-->
		<header class="motopress-wrapper header">
			<div class="container">
				<div class="row">
					<div class="span12" data-motopress-wrapper-file="wrapper/wrapper-header.php" data-motopress-wrapper-type="header" data-motopress-id="55daa2e6ef8b7">
...
<ul id="topnav" class="sf-menu"><li id="menu-item-2025" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="#homePage">Home</a></li>
<li id="menu-item-2091" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="#keyfacts">Why A2Z?</a></li>
<li id="menu-item-2027" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="#service">Services</a></li>
<li id="menu-item-2028" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children"><a href="#aboutPage">About</a>
<ul class="sub-menu">
	<li id="menu-item-2031" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="#companiesPage">Industries we’ve helped</a></li>
	<li id="menu-item-2032" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="#wordsPage">Kind words from happy clients</a></li>
</ul>
</li>
...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		if($.browser.msie && parseInt($.browser.version) < 9){
			...
			jQuery('#parallax-slider-55daa2e6f3c70').parallaxSlider({
...
<div class="motopress-wrapper content-holder clearfix">
	<div class="container">
		...
		<div class="row ">
<div class="span12 "><div class="content_box dark-gray ">
<div class="row ">
...
<h1 style="text-align: right;">Hot spot for<br />
<strong><span style="color: #23ba85;">job seekers </span></strong>and<br />
employers</h1>
</section></div>
...
<div class="hashAncor" id="keyfacts"></div>
<section class="parallax-box image-parallax-box" ><div class="parallax-content">
<div class="title-box clearfix "><h2 class="title-box_primary">Key <strong>Facts</strong></h2></div><!-- //.title-box -->
<div class="row ">
<div class="span4 right"><section class="lazy-load-box trigger effect-slidefromleft " data-delay="0" data-speed="600" style="-webkit-transition: all 600ms ease; -moz-transition: all 600ms ease; -ms-transition: all 600ms ease; -o-transition: all 600ms ease; transition: all 600ms ease;">
<div class="circle-container  clearfix"><script>
							jQuery(document).ready(function() {
								$('.circle').waypoint(function() {
									var myCircle = Circles.create({
										id:         'circles-55daa2e70c980',
										radius:     85,
										value:      90,
										maxValue:   100,
										width:      10,
						...
						</script><div class="circle" id="circles-55daa2e70c980" percent=90></div><div class="desc"><h1>Over 90%</h1><p>Shortlisted CVs Our Client's Want To Interview</p></div></div>
</section></div>
<div class="span4 "><section class="lazy-load-box trigger effect-slidefromright " data-delay="200" data-speed="600" style="-webkit-transition: all 600ms ease; -moz-transition: all 600ms ease; -ms-transition: all 600ms ease; -o-transition: all 600ms ease; transition: all 600ms ease;">
<div class="circle-container  clearfix"><script>
							jQuery(document).ready(function() {
								$('.circle').waypoint(function() {
									var myCircle = Circles.create({
										id:         'circles-55daa2e70cfe0',
										radius:     85,
										value:      95,
										maxValue:   100,
										width:      10,
						...
						</script><div class="circle" id="circles-55daa2e70cfe0" percent=95></div><div class="desc"><h1>Over 95% </h1><p>Acceptance Rate When Offered</p></div></div>
</section></div>
...
<div class="circle-container  clearfix"><script>
						...
						</script><div class="circle" id="circles-55daa2e70d5f9" percent=95></div><div class="desc"><h1>Over 95%</h1><p>Turn Up For The Interview</p></div></div>
</section></div>
</div> <!-- .row (end) -->
...
<p>&nbsp;</p>
<p><center></p>
<h2>Why <span style="color: #23ba85;"><strong> Choose </strong></span> us</h2>
<p>&nbsp;</p>
<p></center>&nbsp;</p>
<p>&nbsp;</p>
<div class="row ">
...
<div class="spacer"></div><!-- .spacer (end) -->
<section class="parallax-box image-parallax-box" ><div class="parallax-content">
<div class="title-box clearfix "><h2 class="title-box_primary">Recruitment<strong> Reimagined</strong></h2></div><!-- //.title-box -->
<div class="row ">
<div class="span6 "><section class="lazy-load-box trigger effect-fade " data-delay="0" data-speed="600" style="-webkit-transition: all 600ms ease; -moz-transition: all 600ms ease; -ms-transition: all 600ms ease; -o-transition: all 600ms ease; transition: all 600ms ease;">
<p style="text-align: justify; padding-left: 60px;"><span style="color: #23ba85; font-size: 15px;">We have a far - reaching vision of Talent Sourcing, Assessment and Management to compliment your in-house team. (In the same style as hot spot for job seekers and employers).</span></p>
</section></div>
<div class="span6 "><section class="lazy-load-box trigger effect-slidefromright " data-delay="200" data-speed="600" style="-webkit-transition: all 600ms ease; -moz-transition: all 600ms ease; -ms-transition: all 600ms ease; -o-transition: all 600ms ease; transition: all 600ms ease;">
...
<p>&nbsp;</p>
<p><center></p>
<h2>Core <span style="color: #23ba85;"><strong> Services </strong></span> we offer</h2>
<p>&nbsp;</p>
<p></center>&nbsp;</p>
<div class="row ">
<div class="span6 "><section class="lazy-load-box trigger effect-slidefromleft " data-delay="0" data-speed="600" style="-webkit-transition: all 600ms ease; -moz-transition: all 600ms ease; -ms-transition: all 600ms ease; -o-transition: all 600ms ease; transition: all 600ms ease;">
...
<div class="title-box clearfix "><h2 class="title-box_primary"><strong>Contact</strong></h2></div><!-- //.title-box -->
<div class="row ">
<div class="span6 "><section class="lazy-load-box trigger effect-slidefromleft " data-delay="0" data-speed="600" style="-webkit-transition: all 600ms ease; -moz-transition: all 600ms ease; -ms-transition: all 600ms ease; -o-transition: all 600ms ease; transition: all 600ms ease;">
<address class="right">
...
<p>Gole Market, Near Cannaught Place</p>
<p>New Delhi, Delhi 110001<br />
<div class="extra-wrap">
<strong><span style="color: #23ba85;">Phone</span></strong><br />
<figure class="alignnone aligntextnone "><i class="icon-phone phone-icon" style="color:#777777; font-size:35px; line-height:1.2em;"></i></figure> +91-11-66782471<br />
</div>
<div class="extra-wrap">
<strong><span style="color: #23ba85;">Email:</span></strong><br />
mail@a2znaukri.com<br />
</div>
<div class="extra-wrap">
<strong><span style="color: #23ba85;">Fax:</span></strong><br />
<figure class="alignnone aligntextnone "><i class="icon-phone phone-icon" style="color:#777777; font-size:35px; line-height:1.2em;"></i></figure>+91 – 11 – 66782403<br />
</div>
</address><!-- address (end) -->
</section>
<p>&nbsp;</p></div>
<div class="span6 "><section class="lazy-load-box trigger effect-slidefromright " data-delay="0" data-speed="600" style="-webkit-transition: all 600ms ease; -moz-transition: all 600ms ease; -ms-transition: all 600ms ease; -o-transition: all 600ms ease; transition: all 600ms ease;">
<div role="form" class="wpcf7" id="wpcf7-f208-p203-o1" dir="ltr">
<div class="screen-reader-response"></div>
<form name="" action="/#wpcf7-f208-p203-o1" method="post" class="wpcf7-form" novalidate="novalidate">
<div style="display: none;">
<input type="hidden" name="_wpcf7" value="208" />
<input type="hidden" name="_wpcf7_version" value="4.2.1" />
<input type="hidden" name="_wpcf7_locale" value="" />
<input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f208-p203-o1" />
<input type="hidden" name="_wpnonce" value="dd0cd84ac8" />
</div>
<div class="fields">
...
<p class="submit-wrap"><input type="submit" value="send" class="wpcf7-form-control wpcf7-submit btn btn-primary submit" /> <input type="reset" value="clear" class="btn btn-primary" /></p>
<div class="wpcf7-response-output wpcf7-display-none"></div></form></div>
		...
		<footer class="motopress-wrapper footer">
			...
			function codeAddress() {
			  var address = "Regus Red Fort Capital Parsvnath Towers, Level 1, Bhai Vir Singh Marg Sector 4, Gole Market New Delhi, Delhi 110001";
			...
			<div class="container">
				<div class="row">
					<div class="span12" data-motopress-wrapper-file="wrapper/wrapper-footer.php" data-motopress-wrapper-type="footer" data-motopress-id="55daa2e72d498">
